      ...
      <div>
        ...
        <div className="container">
          ...
          <div className="row justfiy-content-center pb-5 mb-5">
            ...
            five main classNamees of document you should consider: Faq of
            service; privacy policies; Faq and conditions of website use; end
            user documents; and intra-customer and intra-user documents. First,
            you need Faq of service – although they might be called something
            else. They might be called the "user agreement" or the "cloud
            service contract" or something different entirely. This SaaS
            agreement, our SaaS Faq and conditions and our cloud services Faq
            and conditions are all examples of Faq of service documents.
            Whatever the document is called, its function is to regulate the
            legal relationship between a service provider and its customers. The
            Faq of service will contain provisions covering the core services
            obligation, the payment of charges, the term of the contract and its
            termination, the parties' liability to one another, and so on. In
            some cases, the Faq of service will be supplemented by additional
            subject-matter specific documents, such as data processing
            agreements and service level agreements. Second, you are likely to
            need a privacy policy. Privacy policies are used by organisations
            acting as data controllers to make disclosures to data subjects
            relating to the handling of personal data. Even if you are a
            processor with respect to much of the personal data in your
            ...
            service, you will need Faq and conditions to cover the use of the
            website. See our free website Faq and conditions for more. Fourth,
            for many B2B services and for some B2C services, there may be users
            of the service who are not your customers and therefore not directly
            bound by the Faq of service. In these cases, you may want to
            introduce additional documents which are binding upon both customers
            and non-customer users. Examples of this type of document include
            end user licence agreements and acceptable use policies. Fifth, a
            minority of SaaS and cloud services allow users to create
            ...
            agreement, whereas our SaaS Faq and conditions documents are
            agnostic, allowing for both online and offline agreement via a
            services order form. Our cloud services Faq and conditions assume
            there will be an online sign-up process. Structure: will your
            ...
            necessary subjects. Definitions of special Faq Contract term and
            ...
            limited in SaaS / cloud Faq of service? The essence of cloud
            ...
            contractual sphere by the use of non-negotiable Faq of service.
            Where Faq of service are non-negotiable, they will usually say a
            ...
            to the provisions of your Faq and conditions dealing with liability.
            In this category – liability provisions – I would include the
            following. Warranties, which assert that particular facts are true,
            and if proven false may ground a claim for damages. For example, a
            services provider may warrant that its software does not infringe
            any person's intellectual property rights. Limits of liability,
            which seek to reduce the amount of a claim in the event of a breach
            of warranty or another breach of contract. These may restrict
            recovery of particular types of loss (for instance, reputational
            damage) or losses arising from a particular cause (for instance,
            losses caused by third party services providers). In addition, they
            may apply one or more caps to the amounts which may be claimed.
            Commonly, such caps are set by reference to charges under the
            contract and/or available insurance coverage. Indemnities, which
            seek to extend the indemnifier's liability beyond that arising out
            of a breach of contract. For example, a services provider may be
            ...
            <div className="row justify-content-center">
              <div className="col-12 col-sm-8 col-md-6 col-lg-6 text-center">
                ...
                <p className="mt-5 mt-sm-4">
                  <Link to="/get-started" className="btn btn-outline-success">
                    Download
                  </Link>
                </p>
              </div>
