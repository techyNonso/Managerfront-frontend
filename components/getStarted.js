...
import form_img from "../src/img/form.png";
import company_img from "../src/img/company.png";
import reg_img from "../src/img/reg.png";
import app_img from "../src/img/app.png";
          ...
          <div className="container">
            ...
            <div className="row text-left align-items-center pt-5 pb-md-5">
              <div className="col-4 col-md-5">
                <img alt="image" className="img-fluid" src={up} />
              </div>
            ...
            <div className="row text-left align-items-center pt-5 pb-md-5">
              <div className="col-4 col-md-5 m-md-auto order-md-5">
                <img alt="image" className="img-fluid" src={form_img} />
              </div>
            ...
            <div className="row text-left align-items-center pt-5">
              <div className="col-4 col-md-5">
                <img alt="image" className="img-fluid" src={company_img} />
              </div>
            ...
            <div className="row text-left align-items-center pt-5 pb-md-5">
              <div className="col-4 col-md-5 m-md-auto order-md-5">
                <img alt="image" className="img-fluid" src={reg_img} />
              </div>
            ...
            <div className="row text-left align-items-center pt-5">
              <div className="col-4 col-md-5">
                <img alt="image" className="img-fluid" src={app_img} />
              </div>
