...
import ussgv from "../src/img/ussvg.png";
import features from "../src/froala/imgs/draws/features.svg";
import people from "../src/froala/imgs/people/5.jpg";
            ...
            <div className="row align-items-center">
              <div className="col-12 col-md-12 col-lg-6 col-xl-5">
                ...
                <p className="h1">
                  ...
                  <ExternalLink
                    href="https://www.twitter.com/codypharm"
                    style={{
                      color: "	#1DA1F2",
                      display: "inline-block",
                      padding: "10px",
              ...
              <div className="col-12 col-md-8 m-auto ml-lg-auto mr-lg-0 col-lg-6 pt-5 pt-lg-0">
                <img alt="image" className="img-fluid" src={ussgv} />
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-12 col-md-8 col-lg-6 m-md-auto ml-lg-0 mr-lg-auto">
                <img alt="image" className="img-fluid" src={features} />
              </div>
          ...
          <div className="container">
            <div className="row align-items-center justify-content-center">
              <div className="col-auto">
                <h3>Want to get the best out of your business?</h3>
              </div>
              <div className="col-auto mt-4 mt-sm-0">
                <Link to="/get-started" className="btn btn-success myBtn">
                  Download
                </Link>
              </div>
            </div>
