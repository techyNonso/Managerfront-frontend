...
export const getDebts = (company, branch, startDate, endDate) => (dispatch) => {
  ...
  axiosInstance
    .get(
      `credit-invoices/company/${company}/${branch}/${startYear}/${startMonth}/${startDay}/${endYear}/${endMonth}/${endDay}/`
    )
    .then((res) =>
      dispatch({
        type: GET_DEBTS,
...
export const getDebtsPerCompany =
  (company, startDate, endDate) => (dispatch) => {
    ...
    axiosInstance
      .get(
        `credit-invoices/company/${company}/${startYear}/${startMonth}/${startDay}/${endYear}/${endMonth}/${endDay}/`
      )
      .then((res) =>
        dispatch({
          type: GET_DEBTS,
