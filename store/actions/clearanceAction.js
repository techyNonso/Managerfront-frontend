...
export const getClearance =
  (company, branch, startDate, endDate) => (dispatch) => {
    ...
    axiosInstance
      .get(
        `clearance/company/${company}/${branch}/${startYear}/${startMonth}/${startDay}/${endYear}/${endMonth}/${endDay}/`
      )
      .then((res) =>
        dispatch({
...
export const getClearancePerCompany =
  (company, startDate, endDate) => (dispatch) => {
    let startYear = startDate.getFullYear();
    let startMonth =
      getLength(startDate.getMonth() + 1) == 1
        ? "0" + Number(startDate.getMonth() + 1)
    ...
    axiosInstance
      .get(
        `clearance/company/${company}/${startYear}/${startMonth}/${startDay}/${endYear}/${endMonth}/${endDay}/`
      )
      .then((res) =>
        dispatch({
          type: GET_ALL_CLEARANCE,
