...
export const getSales = (company, branch, startDate, endDate) => (dispatch) => {
  ...
  axiosInstance
    .get(
      `sales/company/${company}/${branch}/${startYear}/${startMonth}/${startDay}/${endYear}/${endMonth}/${endDay}/`
    )
    .then((res) =>
      dispatch({
        type: GET_SALES,
...
export const getSalesPerCompany =
  (company, startDate, endDate) => (dispatch) => {
    ...
    axiosInstance
      .get(
        `sales/company/${company}/${startYear}/${startMonth}/${startDay}/${endYear}/${endMonth}/${endDay}/`
      )
      .then((res) =>
        dispatch({
          type: GET_SALES,
